            ...
            <g>
                ...
                <g transform="translate(245, 65)">
                    ...
                    <motion.circle 
                        ...
                        animate={{
                            boxShadow: "0 0 10px 5px rgba(52, 211, 153, 0.5)",
                    ...
                    />
                    <motion.path
                        d="M 15 95 Q 35 60, 55 95 T 95 95"
                        stroke="#34d399"
                        strokeWidth="1.5"
                        fill="none"
                        variants={wavePathVariants}
                    ...
                    />
                    {/* Floating circles */}
                    <motion.circle cx="15" cy="50" r="2" fill="#34d399" custom={0} variants={circleVariants} />
                    <motion.circle cx="80" cy="65" r="3" fill="#34d399" custom={1} variants={circleVariants} />
                </g>
...
const createPictureBookMutation = useMutation({
    ...
    return (
        <div className="bg-slate-900 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))] text-white">
            ...
            <div className="min-h-screen text-center p-4 pt-48 pb-12">
