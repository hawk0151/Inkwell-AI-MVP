    ...
    terms: { // NEW POLICY TYPE: Terms of Service
        ...
        content: (
            <>
                ...
                <p>By using our Services, you agree to be bound by these Terms, as well as our <Link to="/privacy-policy" className="text-indigo-400 hover:text-indigo-300 transition-colors">Privacy Policy</Link>, <Link to="/refund-policy" className="text-indigo-400 hover:text-indigo-300 transition-colors">Refund Policy</Link>, <Link to="/return-policy" className="text-indigo-400 hover:text-indigo-300 transition-colors">Return Policy</Link>, and <Link to="/shipping-policy" className="text-indigo-400 hover:text-indigo-300 transition-colors">Shipping Policy</Link>, which form part of these Terms. If you do not agree, you must cease use immediately.</p>
                ...
                <ul>
                    ...
                    <li>Once an order is confirmed, production or delivery will proceed as per our <Link to="/refund-policy" className="text-indigo-400 hover:text-indigo-300 transition-colors">Refund Policy</Link> and <Link to="/return-policy" className="text-indigo-400 hover:text-indigo-300 transition-colors">Return Policy</Link>.</li>
    ...
    privacy: {
        ...
        content: (
            <>
                ...
                <p>For any questions or concerns regarding this Privacy Policy or your personal data, please contact us at: 📧 [Insert Privacy Contact Email]</p>
            </>
        ),
    },
    shipping: {
        ...
        content: (
            <>
                ...
                <p>In the unfortunate event that your parcel is lost in transit or arrives damaged, please contact us immediately. Claims for lost or damaged parcels must be lodged with Inkwell AI within <strong>14 days of the estimated delivery date or actual delivery (for damaged items)</strong>. We will assist you in resolving the issue with the shipping carrier or arranging a replacement in accordance with our <Link to="/refund-policy" className="text-indigo-400 hover:text-indigo-300 transition-colors">Refund Policy</Link> and <Link to="/return-policy" className="text-indigo-400 hover:text-indigo-300 transition-colors">Return Policy</Link>.</p>
            </>
        ),
    },
    refund: {
    ...
    return: {
        ...
        content: (
            <>
                ...
                <p><strong>Digital products cannot be "returned"</strong> once delivered. Please refer to our <Link to="/refund-policy" className="text-indigo-400 hover:text-indigo-300 transition-colors">Refund Policy</Link> for details regarding digital product issues.</p>
                ...
                <ul>
                    <li>A full refund issued to your original payment method (as per our <Link to="/refund-policy" className="text-indigo-400 hover:text-indigo-300 transition-colors">Refund Policy</Link>), or</li>
