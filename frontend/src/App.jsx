...
import PictureBookPreviewPage from './pages/PictureBookPreviewPage.jsx';
        ...
        <div className="min-h-screen bg-slate-900 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))] text-slate-200 font-sans flex flex-col">
            ...
            <main className="flex-grow w-full">
                <Routes>
                    ...
                    <Route path="/picture-book/new" element={<ProtectedRoute><PictureBookPage /></ProtectedRoute>} /> 
                    <Route path="/picture-book/:bookId" element={<ProtectedRoute><PictureBookPage /></ProtectedRoute>} />
                    <Route path="/picture-book/:bookId/preview" element={<ProtectedRoute><PictureBookPreviewPage /></ProtectedRoute>} />
