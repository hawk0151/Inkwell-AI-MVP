...
export const createBookCheckoutSession = async (req, res) => {
    ...
    try {
        ...
        await client.query(`UPDATE picture_books SET lulu_product_id = $1, interior_pdf_url = $2, cover_pdf_url = $3 WHERE id = $4`, [productInfo.id, interiorPdfUrl, coverPdfUrl, bookId]);
