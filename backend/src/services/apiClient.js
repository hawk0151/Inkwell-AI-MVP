...
// --- FIX: This is the only section that has been changed ---
// The base URL is read from the environment variables.
// If VITE_API_BASE_URL is not found, it defaults to your local backend.
const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'http://localhost:5001';

// Create an Axios instance
const apiClient = axios.create({
    // The '/api' prefix is now consistently added here in the code.
