 ...
 * Fully reverted to gemini-2.0-flash for compatibility with old books.
 */
 ...
 */
export const callGeminiAPI = async (prompt, model = 'gemini-2.0-flash', safetySettings = [], generationConfig = {}) => {
 ...
 */
export const createStoryBible = async (previousChaptersText, model = 'gemini-2.0-flash') => {
 ...
 */
export const createChapterPlan = async (storyBible, model = 'gemini-2.0-flash') => {
...
export const generateStoryFromApi = async (promptDetails, guidance = '', safetySettings = []) => {
    ...
    const rawResponse = await callGeminiAPI(prompt, 'gemini-2.0-flash', safetySettings);
...
export const getVisualKeywordsFromDescription = async (description) => {
    ...
    try {
        const keywords = await callGeminiAPI(masterPrompt, 'gemini-2.0-flash');
